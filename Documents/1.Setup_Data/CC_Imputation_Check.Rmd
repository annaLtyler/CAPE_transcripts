...
## Correlation between CC-RIX - DO correspondence and LOD score
...
f.file <- here("Results", "CCA_Clusters", "imputed_local", "CC-RIX_transcript_F_tests.RDS")
...
comp.table <- cbind(log(f), var.comp[common.transcripts,"local_VE"], cis.lod)
colnames(comp.table) <- c("log(F)", "Local VE", "Local LOD")
pairs(comp.table)
```
