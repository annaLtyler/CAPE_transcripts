...
#quartz(width = 11, height = 5);barplot(t(group.ind[group.order,]), col = c("red", "blue"), border = NA);abline(h = length(qtl.markers)/2)
pheatmap(group.ind)
```
...
```{r pheno_diff, fig.width = 12, fig.height = 12}
