...
overlap.genes <- read.table("~/Downloads/results.tsv", stringsAsFactors = FALSE, sep = "\t")
gene.name <- overlap.genes[,2]
...
#bulk mediation for subsets of related genes
#all.expr <- matched.mats[[tissue.locale]]$X[,gene.locale,drop=FALSE]
#colnames(all.expr) <- gene.names
