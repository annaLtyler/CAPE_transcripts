...
tissue.name = "Islet"; network.name = "islets of langerhans"; 
#tissue.name = "Adipose"; network.name = "adipose tissue"
#tissue.name = "SkeletalMuscle"; network.name = "skeletal muscle"
#tissue.name = "Liver"; network.name = "liver"
...
qtl.scan <- scan1(genoprobs[,qtl.chr], rankZ(adj.pheno[,trait.name]))
#plot(qtl.scan, map = map)
peak.table <- find_peaks(qtl.scan,map = map, prob = 0.95)
