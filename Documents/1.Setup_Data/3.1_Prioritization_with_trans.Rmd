...
plot(gene.pos, all.cis.trans.med[,1], main = "Trans-band mediators", 
...
abline(v = 1, h = 0.8)
top.genes <- which(all.cis.trans.med[common.genes,1] > 0.8)
...
abline(v = 1, h = 0.8)
top.genes <- which(all.cis.trait.med[common.genes,1] > 0.8)
if(length(top.genes) > 0){
    text(x = -log10(fp.mat[common.genes[top.genes],1]), all.cis.trait.med[common.genes[top.genes],1],
        labels = common.genes[top.genes], pos = 4)
}
