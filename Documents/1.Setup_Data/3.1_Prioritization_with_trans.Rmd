...
test <- read.csv("/Users/atyler/Documents/Projects/Islets/CAPE_transcripts/Results/Prioritization/Chr11_Trans/Adipose_Chr11_Trans/Module1/Candidate.Gene.Results.csv")
top.scores <- which(test[,"Mean.SVM.Score"] > 1.25)
plot(test[top.scores,c("Mean.SVM.Score", "Mean.FP.Rate")])
text(test[top.scores,"Mean.SVM.Score"], test[top.scores,"Mean.FP.Rate"], labels = test[top.scores,2], pos = 3)
