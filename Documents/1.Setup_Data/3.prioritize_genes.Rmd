...
#tissue.name = "Islet"; network.name = "islets of langerhans";CT = 1; qtl.chr = "X";exp.name = "ChrX"
...
qtl.scan <- readRDS(here("Results", "CCA_clusters", "all_traits", paste0("QTL.", tissue.name, ".trait.RDS")))
